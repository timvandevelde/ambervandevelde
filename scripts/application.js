...
jQuery( document ).ready(function($) {
  ...
  if (isMobile == false) {
    ...
    sr.reveal('.vertical-slide', {
      duration: 1000,
      distance: '50px',
      scale: 1,
      easing: 'ease-out',
    });
    sr.reveal('.vertical-slide-visible', {
      duration: 1000,
      distance: '50px',
      scale: 1,
      easing: 'ease-out',
  ...
  $(".hamburger").click(function(){
    $(".menu-overlay").addClass("activating").delay(1000).queue(function(){
      $(this).addClass("active").removeClass("activating").dequeue();
    });
  });
